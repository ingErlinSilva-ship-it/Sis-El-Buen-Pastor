...
<div class="container-fluid pt-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow border-0"
                style="border-radius: 20px; background: linear-gradient(135deg, #1e40af 0%, #0891b2 100%); color: white;">
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <div class="mt-2">
                                <a href="{{ route('usuario.edit', Auth::user()->id) }}"
                                    ...
                                    style="border-radius: 50px; color: #1e40af;">
                        ...
                        <div class="col-md-4 text-right d-none d-md-block">
                            @if(Auth::user()->foto)
                                <img src="{{ asset('storage/' . Auth::user()->foto) }}" class="img-circle shadow-lg"
                                    alt="User Image"
    ...
    <div class="row">
    {{-- COLUMNA IZQUIERDA: Mi Perfil y Mis Citas --}}
    <div class="col-lg-4 col-md-5 col-12">
        
        {{-- Mi perfil --}}
        <div class="info-box shadow-sm border-0 mb-3" style="border-radius: 15px;">
            <span class="info-box-icon bg-primary elevation-1" style="border-radius: 12px;">
                <i class="fas fa-user-circle"></i>
            </span>
            <div class="info-box-content">
                <span class="info-box-text text-muted font-weight-bold">Mi Cuenta</span>
                <span class="info-box-number h5 mb-0">Datos personales</span>
                <a href="{{ route('usuario.show', Auth::user()->id) }}" class="small text-primary font-weight-bold">
                    Ver mi perfil <i class="fas fa-chevron-right ml-1 "></i>
                </a>
            </div>
        </div>
        ...
        <div class="info-box shadow-sm border-0" style="border-radius: 15px;">
            <span class="info-box-icon bg-info elevation-1" style="border-radius: 12px;">
                <i class="fas fa-calendar-alt"></i>
            </span>
            <div class="info-box-content">
                <span class="info-box-text text-muted font-weight-bold">Mis Citas</span>
                <span class="info-box-number h5 mb-0">{{ $totalCitas }} registradas</span>
                <a href="{{ route('cita.index') }}" class="small text-info font-weight-bold">
                    Ir a mi calendario <i class="fas fa-chevron-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    {{-- COLUMNA DERECHA: Detalle de Próxima Cita --}}
            ...
            <div class="card-body d-flex flex-column justify-content-center">
                @if($proximaCita)
                    <div class="p-4" style="border-radius: 15px; background-color: #f8fbff; border: 1px solid #e3f2fd;">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="bg-white shadow-sm d-flex align-items-center justify-content-center rounded-circle"
                            ...
                            <div class="col">
                                ...
                                <p class="mb-0 text-sm text-muted">
                                    <i class="far fa-clock mr-1"></i> {{ \Carbon\Carbon::parse($proximaCita->hora)->format('h:i A') }}
                                </p>
                                <p class="mb-0 text-sm text-muted">
                                    <i class="fas fa-user-md mr-1"></i> Dr. {{ $proximaCita->medico->usuario->apellido }}
                                </p>
                            </div>
                            <div class="col-md-4 text-right">
                                <a href="{{ route('cita.index') }}" class="btn btn-primary btn-sm rounded-pill px-3 shadow-sm">
                                    Ver detalles
                                </a>
                            </div>
                        </div>
                ...
                @else
                    <div class="text-center py-4">
                        <i class="fas fa-calendar-minus fa-2x mb-2 d-block text-muted opacity-50"></i>
                        <h6 class="text-muted">No hay citas programadas</h6>
                        <a href="{{ route('cita.create') }}" class="btn btn-sm btn-outline-primary mt-2 rounded-pill">
                            Agendar ahora
                        </a>
                    </div>
                @endif
