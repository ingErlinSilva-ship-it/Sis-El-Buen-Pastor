                ...
                <div class="card border-0 shadow-lg" style="border-radius: 15px; overflow: hidden;">
                    <div class="card-header bg-white py-3 shadow-sm" style="border-top: 5px solid #28a745;">
                        <div class="d-flex align-items-center">
                            <div class="rounded-circle p-2 mr-3" style="background-color: #e8f5e9; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                            ...
                            <div class="col-md-4 text-center border-right">
                                <div class="mb-3 d-flex justify-content-center">
                                    @if($medico->usuario && $medico->usuario->foto)
                                        <div class="rounded-circle shadow-sm" style="width: 140px; height: 140px; overflow: hidden; border: 5px solid #28a745;">
                                ...
                                <h4 class="font-weight-bold text-dark mb-1 text-capitalize">
                                    {{ explode(' ', $medico->usuario->nombre)[0] }} {{ explode(' ', $medico->usuario->apellido)[0] }}
                                </h4>
                            ...
                            <div class="col-md-8">
                                <div class="row px-3">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <label class="label-custom text-success"><i class="fas fa-user-circle mr-1"></i> Usuario del Sistema</label>
                                    ...
                                    {{-- Código MINSA --}}
                                    <div class="col-md-6 mb-4">
                                        <label class="label-custom text-success"><i class="fas fa-id-card mr-1"></i> Código MINSA</label>
                                        <div class="input-box-container">
                                    ...
                                    {{-- Descripción --}}
                                    <div class="col-md-12">
                                        <label class="label-custom text-success"><i class="fas fa-file-alt mr-1"></i> Descripción Profesional</label>
                                        <div class="input-box-container">
                                            <textarea name="descripcion" class="form-control-custom" rows="4">{{ old('descripcion', $medico->descripcion) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
