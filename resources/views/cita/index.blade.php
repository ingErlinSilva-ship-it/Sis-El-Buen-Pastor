                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="float-right">
                            <a href="{{ route('cita.create') }}" class="btn btn-primary btn-sm float-right"
                                data-placement="left">
                                {{ __('Crear Nueva Cita') }}
                            </a>
                        </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($citas as $cita)
                                    <tr>
                                        {{-- SOLUCIÓN AL ERROR: Usamos loop->iteration en lugar de $i --}}
                                        <td>{{ $loop->iteration }}</td>

                                        <td>{{ $cita->paciente->usuario->nombre }} {{ $cita->paciente->usuario->apellido }}
                                        </td>
