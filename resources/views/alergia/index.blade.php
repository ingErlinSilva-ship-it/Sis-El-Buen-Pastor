    ...
    <div class="row align-items-center">
        <div class="col-6 text-left">
            <h1 class="m-0 text-dark font-weight-bold" style="font-size: 1.6rem;">
                <i class="fas fa-fw fa-allergies text-primary mr-2"></i> {{ __('Catálogo de Alergias') }}
            </h1>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th class="border-0 py-3 text-muted">{{ __('Nombre de la Alergia') }}</th>
            ...
            <div class="mt-4 d-flex justify-content-center">
                {!! $alergias->withQueryString()->links('pagination::bootstrap-4') !!}
            </div>
        </div>
    </div>
</div>
        ...
        $(document).ready(function () {
            $('.form-eliminar').submit(function (e) {
                ...
                Swal.fire({
                    ...
                    text: "Esta información desaparecerá del catálogo médico.",
                    icon: 'warning',
...
@push('css')
    <style>
        /* Estilos de Inversión Unificados */
        .btn-invert-blue,
        .btn-invert-purple,
        .btn-invert-success,
        .btn-invert-danger {
